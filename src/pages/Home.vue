  ...
  <div class="flex min-h-screen flex-col items-center justify-center bg-slate-50 p-6">
    <div class="w-full max-w-2xl space-y-8">
      ...
      <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
        ...
        <router-link
          to="/new-music"
          class="group relative flex cursor-pointer flex-col justify-between overflow-hidden rounded-3xl bg-white p-7 shadow-lg ring-1 shadow-slate-950/5 ring-slate-200/70 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-emerald-500/10 hover:ring-emerald-500/50"
        >
          <div
        ...
        <router-link
          to="/import-music"
          class="group relative flex cursor-pointer flex-col justify-between overflow-hidden rounded-3xl bg-white p-7 shadow-lg ring-1 shadow-slate-950/5 ring-slate-200/70 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-blue-500/10 hover:ring-blue-500/50"
        >
          <div
      ...
      <div class="space-y-2">
        ...
        <div class="flex items-center justify-between px-2 pb-1">
          <div class="flex items-center gap-2">
            <span class="text-xs font-bold tracking-wider text-slate-400 uppercase">最近项目</span>
            <span
          ...
          >
            ...
            <div class="flex min-w-0 items-center gap-3.5">
              ...
              <div class="min-w-0 space-y-0.5">
                ...
                <div class="flex items-center gap-2 text-xs text-slate-400">
                  <span class="max-w-50 truncate">{{ song.audioFile?.name || '无音频源' }}</span>
            ...
            <div class="flex shrink-0 items-center gap-1">
              <el-button
                type="primary"
                link
                class="!ext-emerald-600 rounded-lg px-3 py-1.5 text-xs font-semibold transition-colors hover:bg-emerald-50 hover:text-emerald-700"
              ...
              <el-popconfirm
                ...
                width="180"
                @confirm="handleDelete(song.id)"
              >
                <template #reference>
                  <el-button
                    type="danger"
                    link
                    class="rounded-lg px-2 py-1.5 text-xs font-normal text-slate-400 transition-colors hover:bg-rose-50 hover:text-rose-600"
                  >
                    <el-icon :size="15">
                      <Delete />
                    </el-icon>
